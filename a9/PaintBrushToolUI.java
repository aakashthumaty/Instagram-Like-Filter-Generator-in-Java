...
public class PaintBrushToolUI extends JPanel implements ChangeListener {
	...
	public PaintBrushToolUI() {
		...
		//color_chooser_panel.add(takeCurPix, BorderLayout.SOUTH);
	...
	//returns brush size derived from slider for changing brush size functionality
	
	public int getBrushSize() {
		return size_slider.getValue();
	}
	
	//used to set color of brush for copy pixel functionality
